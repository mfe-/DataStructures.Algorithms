...
namespace NetworkAddressChangedNotification
{
    ...
    {
        WlanNotificationCallbackDelegate wlanNotificationCallbackDelegate;

        public NativeWifiWrapper()
        {
            //todoNativeWifiWrapper.WlanRegisterNotification();
            this.wlanNotificationCallbackDelegate = new WlanNotificationCallbackDelegate(WlanNotificationCallback);
        }
