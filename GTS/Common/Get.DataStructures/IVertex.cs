...
namespace Get.DataStructure
{
        ...
        where W : IComparable<W>  
    {
        ...
        /// </summary>
        IEnumerable<IEdge<W>> Edges { get; set; }
        ...
        IEdge<W> AddEdge(IVertex<W> U, W Weight, Boolean Undirected);
        ...
        void RemoveEdge(IVertex<W> U, Boolean Undirected);
    }
}
